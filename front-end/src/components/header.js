            ...
            {isBoxOpen && (
                <div className="center-box">
                    <div className="center-header-icons">
                        <button className="center-header-icon"><img src={radioIcon} alt="radioIcon"/></button>
                        <button className="center-header-icon"><img src={postIcon} alt="postIcon"/></button>
                        <button className="center-header-icon"><img src={disabilityIcon} alt="disabilityIcon"/></button>
                        <button className="center-header-icon"><img src={enIcon} alt="enIcon"/></button>
                    </div>
